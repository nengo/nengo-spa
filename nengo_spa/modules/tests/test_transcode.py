...
def test_fixed(Simulator, seed):
    with spa.Network(seed=seed) as model:
        ...
        spa.Actions(
            'model.input1 -> model.buffer1; model.input2 -> model.buffer2')
...
def test_time_varying_encode(Simulator, seed):
    with spa.Network(seed=seed) as model:
        ...
        spa.Actions('model.encode -> model.buffer')
